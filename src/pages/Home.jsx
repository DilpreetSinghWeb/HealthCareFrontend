...
const Home = () => {
  return (
    <>
      {/* Hero start*/}
      <section className="hero__section pt-[60px] 2xl:h-[625px]">
          ...
          <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
            ...
            <div>
              <div className="lg:w-[570px]">
                <h1 className="text-[36px] leading-[46px] text-headingColor font-extrabold md:text-[50px] md:leading-[70px]">
                  We help patients live a healthy, longer life.
                </h1>
                <p className="text__para">
                At our clinic, we prioritize your health. Our dedicated team of professionals provides personalized care, ensuring you receive the attention and treatment you deserve. From routine check-ups to specialized consultations, we&apos;re here to support your wellness journey.
...
<Link to={'/doctors'}>
            ...
            <div className="flex gap-[30px] justify-end">
              <div>
                <img className="w-full" src={heroImg01} alt="Doctor_01" />
              </div>
      ...
      <section>
        ...
        <div className="container grid grid-col-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] lg:mt-[55px]">
          ...
          <div className="flex items-center justify-between flex-col lg:flex-row ">
            ...
            <div className="xl:w-[670px]">
              ...
              <ul className="pl-4">
                ...
                <li className="text__para">
                  2. Search for your physical here, and contact their office.
                </li>
                <li className="text__para">
            ...
            <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
              ...
              <div className="w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]">
                ...
                <div className="flex items-center gap-[6px] lg:gap-[10px] mt-2 lg:mt-[18px]">
                  ...
                  <h4 className="text-[10px] lg:text-[16px] leading-3 lg:leading-[22px] font-[700] text-textColor">Wayne Collins</h4>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="flex justify-between gap-[50px] lg:gap-0">
            <div className="w-1/2 hidden md:block">
              <img className="h-[600px]" src={faqImg} alt="FaqDoctorImg" />
            </div>
